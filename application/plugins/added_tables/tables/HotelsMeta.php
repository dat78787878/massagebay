...
class HotelsMeta{
	...
	private function addTable(){
		...
		$dttable->addField("id","int","id");$dttable->addField("name","varchar(255)","Tên khách sạn");$dttable->addField("place_id","varchar(255)","Địa điểm");$dttable->addField("amenities_and_services","varchar(255)","Tiện nghi và dịch vụ");$dttable->addField("score","varchar(255)","Điểm đánh giá");$dttable->addField("short_content","text(65535)","Mô tả ngắn");$dttable->addField("content","text(65535)","Nội dung");$dttable->addField("img","text(65535)","Hình ảnh");$dttable->addField("lib_img","text(65535)","Thư viện ảnh");$dttable->addField("act","tinyint","Kích hoạt");$dttable->addField("ord","int","Sắp xếp");$dttable->addField("count","int","Số lượt xem");$dttable->addField("home","tinyint","Hiển thị trang chủ");$dttable->addField("create_time","bigint","Thời gian tạo");$dttable->addField("update_time","bigint","Thời gian cập nhật");
		$dttable->build();
	}
	...
	private function createModule(){
		...
		$m->insertGroupModule('Khách sạn',"view/".$this->table,178,'icon-camera',2);
	}
